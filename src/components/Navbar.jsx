          ...
          <div className="hidden md:flex items-center gap-4">
            {!isPending && (!user ? (
              ...
              <div className="relative group">
                <button className="flex items-center gap-2 p-1 rounded-full border hover:bg-default-100 transition-colors">
                ...
                {/* Dropdown Menu */}
                <div className="absolute right-0 top-12 w-48 bg-background border border-default-200 rounded-2xl shadow-xl hidden group-hover:flex flex-col py-1.5 z-50">
                  ...
                  <Link href="/profile" className="px-4 py-2 text-sm hover:bg-default-100 flex items-center gap-2">
                    <User className="w-4 h-4" /> Profile
                  </Link>
                  <button onClick={handleLogout} className="px-4 py-2 text-sm text-danger hover:bg-danger-50 flex items-center gap-2 text-left w-full">
