...
const LatestTickets = async () => {
  ...
  return (
    <section className="py-20 bg-white dark:bg-gray-950 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end mb-12 gap-4">
          ...
          <Link
            href="/tickets"
            className="hidden sm:flex items-center gap-2 text-blue-600 font-bold hover:text-blue-700 bg-blue-50 dark:bg-blue-500/10 px-5 py-2.5 rounded-xl transition-all hover:scale-105"
          >
