    ...
    return (
        <div className="flex items-center justify-center min-h-[85vh] w-full px-4 py-8 sm:py-12 font-sans overflow-hidden transition-colors duration-300">
            <motion.div 
                ...
                className="w-full max-w-xl bg-white/90 dark:bg-gray-900/90 backdrop-blur-2xl border border-gray-200 dark:border-gray-800 shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)] rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden relative transition-all duration-500"
            >
                ...
                <motion.div 
                    ...
                    className="h-32 sm:h-48 bg-gradient-to-tr from-blue-600 via-indigo-500 to-purple-600 relative overflow-hidden"
                >
                ...
                <div className="px-5 sm:px-10 pb-8 sm:pb-12 pt-2 relative flex flex-col items-center">
                    ...
                    <motion.div 
                        ...
                        className="relative -mt-16 sm:-mt-24 mb-4 sm:mb-6 group"
                    >
                        <div className="w-24 h-24 sm:w-36 sm:h-36 rounded-full border-[4px] sm:border-[6px] border-white dark:border-gray-900 overflow-hidden shadow-2xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center relative transition-transform duration-500 group-hover:scale-[1.02]">
                            ...
                            {isEditing && (
                                <label className="absolute inset-0 bg-gray-900/60 backdrop-blur-sm flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer z-10">
                                    ...
                                    >
                                        <UploadCloud className="w-8 h-8 sm:w-10 sm:h-10 text-white mb-1 sm:mb-2" />
                                    </motion.div>
                    ...
                    <div className="w-full space-y-5 sm:space-y-7">
                        ...
                        <motion.div 
                            ...
                            className="w-full h-px bg-gradient-to-r from-transparent via-gray-200 dark:via-gray-700 to-transparent my-4 sm:my-6"
                        ></motion.div>
                        ...
                        <div className="space-y-3 sm:space-y-4">
                            {!isEditing && (
                                <motion.div 
                                    ...
                                    className="group flex items-center gap-3 sm:gap-5 px-4 sm:px-6 py-3 sm:py-4.5 bg-gray-50 hover:bg-gray-100 dark:bg-gray-800/40 dark:hover:bg-gray-800 rounded-xl sm:rounded-2xl border border-gray-200/60 dark:border-gray-700/60 transition-all duration-300 shadow-sm hover:shadow-md"
                                >
                            ...
                            >
                                ...
                                {isEditing && (
                                    <motion.div 
                                        ...
                                        className="px-2 sm:px-3 py-1 sm:py-1.5 bg-gray-200/50 dark:bg-gray-700/50 rounded-lg"
                                    >
