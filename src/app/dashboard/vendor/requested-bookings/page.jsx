...
// import { getVendorBookings, updateBookingStatus } from "@/lib/actions/bookings";
          ...
          <table className="w-full text-left text-sm text-gray-600">
            <thead className="bg-gray-50 text-gray-900 border-b border-gray-100">
              <tr>
                ...
                <th className="p-4 font-bold whitespace-nowrap">Total Price</th>
                <th className="p-4 font-bold text-center whitespace-nowrap">
                  Status
                </th>
                      ...
                      {booking.status === "pending" ? (
                        <>
                          <button
                            ...
                            className="p-2 bg-green-50 text-green-600 hover:bg-green-100 rounded-lg transition-colors disabled:opacity-50 cursor-pointer"
                            title="Accept"
                          >
                            <CheckCircle size={18} />
                          </button>
                          <button
                            ...
                            disabled={processingId === booking._id}
                            className="p-2 bg-red-50 text-red-600 hover:bg-red-100 rounded-lg transition-colors disabled:opacity-50 cursor-pointer"
                            title="Reject"
                          >
                            <XCircle size={18} />
                          </button>
                        ...
                        <span className="text-xs font-bold text-gray-400 py-2 px-3 bg-gray-50 rounded-md border border-gray-100">
                          Reviewed
                        </span>
                      )}
                    </td>
